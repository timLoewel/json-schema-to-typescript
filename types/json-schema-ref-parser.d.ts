declare module 'json-schema-ref-parser' {
  ...
  class $RefParser {
     ...
     */
    dereference<T extends $RefParser.JSONSchema>(schema: string | T, callback: $RefParser.SchemaCallback<T>): void
    dereference<T extends $RefParser.JSONSchema>(schema: string | T, options: $RefParser.Options, callback: $RefParser.SchemaCallback<T>): void
    dereference<T extends $RefParser.JSONSchema>(baseUrl: string, schema: string | $RefParser.JSONSchema, options: $RefParser.Options, callback: $RefParser.SchemaCallback<T>): void
    dereference<T extends $RefParser.JSONSchema>(schema: string | T): Promise<T>
    dereference<T extends $RefParser.JSONSchema>(schema: string | T, options: $RefParser.Options): Promise<T>
    dereference<T extends $RefParser.JSONSchema>(baseUrl: string, schema: string | T, options: $RefParser.Options): Promise<T>
     ...
     * @param callback (optional) A callback that will receive the dereferenced schema object
     */
    static dereference<T extends $RefParser.JSONSchema>(schema: string | T, callback: $RefParser.SchemaCallback<T>): void
    static dereference<T extends $RefParser.JSONSchema>(schema: string | T, options: $RefParser.Options, callback: $RefParser.SchemaCallback<T>): void
    static dereference<T extends $RefParser.JSONSchema>(baseUrl: string, schema: string | T, options: $RefParser.Options, callback: $RefParser.SchemaCallback<T>): void
    static dereference<T extends $RefParser.JSONSchema>(schema: string | T): Promise<T>
    static dereference<T extends $RefParser.JSONSchema>(schema: string | T, options: $RefParser.Options): Promise<T>
    static dereference<T extends $RefParser.JSONSchema>(baseUrl: string, schema: string | T, options: $RefParser.Options): Promise<T>
     ...
     */
    bundle<T extends $RefParser.JSONSchema>(schema: string | T, callback: T): void
    bundle<T extends $RefParser.JSONSchema>(schema: string | T, options: $RefParser.Options, callback: T): void
    bundle<T extends $RefParser.JSONSchema>(baseUrl: string, schema: string | T, options: $RefParser.Options, callback: T): void
    bundle<T extends $RefParser.JSONSchema>(schema: string | $RefParser.JSONSchema): Promise<T>
    bundle<T extends $RefParser.JSONSchema>(schema: string | T, options: $RefParser.Options): Promise<T>
    bundle<T extends $RefParser.JSONSchema>(baseUrl: string, schema: string | T, options: $RefParser.Options): Promise<T>
     ...
     * @param callback (optional) A callback that will receive the bundled schema object
     */
     static bundle<T extends $RefParser.JSONSchema>(schema: string | T, callback: T): void
     static bundle<T extends $RefParser.JSONSchema>(schema: string | T, options: $RefParser.Options, callback: T): void
     static bundle<T extends $RefParser.JSONSchema>(baseUrl: string, schema: string | T, options: $RefParser.Options, callback: T): void
     static bundle<T extends $RefParser.JSONSchema>(schema: string | $RefParser.JSONSchema): Promise<T>
     static bundle<T extends $RefParser.JSONSchema>(schema: string | T, options: $RefParser.Options): Promise<T>
     static bundle<T extends $RefParser.JSONSchema>(baseUrl: string, schema: string | T, options: $RefParser.Options): Promise<T>
     ...
     */
    parse<T extends $RefParser.JSONSchema>(schema: string | T, callback: $RefParser.SchemaCallback<T>): void
    parse<T extends $RefParser.JSONSchema>(schema: string | T, options: $RefParser.Options, callback: $RefParser.SchemaCallback<T>): void
    parse<T extends $RefParser.JSONSchema>(baseUrl: string, schema: string | T, options: $RefParser.Options, callback: $RefParser.SchemaCallback<T>): void
    parse<T extends $RefParser.JSONSchema>(schema: string | T): Promise<T>
    parse<T extends $RefParser.JSONSchema>(schema: string | T, options: $RefParser.Options): Promise<T>
    parse<T extends $RefParser.JSONSchema>(baseUrl: string, schema: string | T, options: $RefParser.Options): Promise<T>
     ...
     * @param callback (optional) A callback that will receive the parsed schema object, or an error
     */
     static parse<T extends $RefParser.JSONSchema>(schema: string | T, callback: $RefParser.SchemaCallback<T>): void
     static parse<T extends $RefParser.JSONSchema>(schema: string | T, options: $RefParser.Options, callback: $RefParser.SchemaCallback<T>): void
     static parse<T extends $RefParser.JSONSchema>(baseUrl: string, schema: string | T, options: $RefParser.Options, callback: $RefParser.SchemaCallback<T>): void
     static parse<T extends $RefParser.JSONSchema>(schema: string | T): Promise<T>
     static parse<T extends $RefParser.JSONSchema>(schema: string | T, options: $RefParser.Options): Promise<T>
     static parse<T extends $RefParser.JSONSchema>(baseUrl: string, schema: string | T, options: $RefParser.Options): Promise<T>
  ...
  namespace $RefParser {
    ...
    export type SchemaCallback<T extends JSONSchema> = (err: Error | null, schema?: T) => any
